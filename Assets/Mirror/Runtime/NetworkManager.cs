...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        public virtual void ServerChangeScene(string newSceneName, LoadSceneMode sceneMode, LocalPhysicsMode physicsMode)
        {
            ...
            loadingSceneAsync = LoadSceneAsync(newSceneName, loadSceneParameters);
        ...
        protected virtual AsyncOperationWrapper LoadSceneAsync(string newSceneName, LoadSceneParameters loadSceneParameters) {
            return new AsyncOperationWrapper(SceneManager.LoadSceneAsync(newSceneName, loadSceneParameters));
        }
